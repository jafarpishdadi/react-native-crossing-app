...
export  default class CitySectionList extends PureComponent {
    ...
    constructor(props, context) {
        ...
        this.state = {text: '', isShow: false, showBlacker: false}
    }
        ...
        for (let i = 0; i < this.props.sections.length; i++) {
            array.push(
                <View
                    ...
                    ref={'sectionItem' + i}>
                    <Text
                        style={[styles.sectionItem, {color: this.state.showBlacker ? '#666666' : '#ABABAB'}]}>{this.props.sections[i]}</Text>
                </View>)
        }
        return array;
    }
    ...
    detectAndScrollToSection = (e) => {
        this.setState({showBlacker: true})
    ...
    resetSection = () => {
        ...
        this.setState({isShow: false, showBlacker: false})
        this.lastSelectedIndex = null;
